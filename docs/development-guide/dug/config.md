...
`-f <path-to-your-values-file>` The `-f` flag allows you to specify a values file (`<path-to-your-values-file>`) that contains configuration settings for the Helm chart. Replace `<path-to-your-values-file>` with the path to and filename of your values file.
